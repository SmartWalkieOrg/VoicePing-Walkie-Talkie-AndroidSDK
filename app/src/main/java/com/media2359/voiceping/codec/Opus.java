...
//    }
    ...
    private Opus(int sampleRate, int channel) {
        this.sampleRate = sampleRate;
        this.channel = channel;
        encoder = encoder_create(sampleRate, channel);
        encoder_set_vbr(encoder, 0);
        decoder = decoder_create(sampleRate, channel);
    }
     ...
     */
    private native long decoder_create(int Fs, int channels);
     ...
     */
    private native void decoder_destroy(long decoder);
     ...
     */
    private native int decoder_get_nb_samples(
            long decoder,
     ...
     */
    private native int decoder_get_size(int channels);
     ...
     * @param outputOffset The number offset of <tt>output</tt>.
     ...
     */
    private native long encoder_create(int Fs, int channels);
     ...
     */
    private native void encoder_destroy(long encoder);
     ...
     */
    private native int encoder_get_bandwidth(long encoder);
     ...
     */
    private native int encoder_get_bitrate(long encoder);

    private native int encoder_get_complexity(long encoder);
     ...
     */
    private native int encoder_get_dtx(long encoder);
     ...
     */
    private native int encoder_get_inband_fec(long encoder);
     ...
     */
    private native int encoder_get_size(int channels);
     ...
     */
    private native int encoder_get_vbr(long encoder);
     ...
     */
    private native int encoder_get_vbr_constraint(long encoder);
     ...
     */
    private native int encoder_set_bandwidth(long encoder, int bandwidth);
     ...
     */
    private native int encoder_set_bitrate(long encoder, int bitrate);
     ...
     * @return OPUS_OK on success
     */
    private native int encoder_set_complexity(long encoder,
                                              int complexity);
     ...
     * @return OPUS_OK on success
     */
    private native int encoder_set_dtx(long encoder, int dtx);
     ...
     * @return OPUS_OK on success
     */
    private native int encoder_set_force_channels(long encoder,
                                                  int forcechannels);
     ...
     * @return OPUS_OK on success
     */
    private native int encoder_set_inband_fec(long encoder,
                                              int inbandFEC);
     ...
     * @return <tt>OPUS_OK</tt> on success.
     */
    private native int encoder_set_max_bandwidth(long encoder,
                                                 int maxBandwidth);
     ...
     *
     * @param encoder The encoder to use
     * @param packetLossPerc The packet loss
     *
     * @return OPUS_OK on success.
     */
    private native int encoder_set_packet_loss_perc(long encoder,
                                                    int packetLossPerc);
     ...
     * @return OPUS_OK on success
     */
    private native int encoder_set_vbr(long encoder, int vbr);
     ...
     * @return OPUS_OK on success
     */
    private native int encoder_set_vbr_constraint(long encoder,
                                                  int use_cvbr);
     ...
     */
    private native int packet_get_bandwidth(byte[] data, int offset);
     ...
     */
    private native int packet_get_nb_channels(byte[] data, int offset);
     ...
     */
    private native int packet_get_nb_frames(byte[] packet, int offset,
                                            int length);
}
