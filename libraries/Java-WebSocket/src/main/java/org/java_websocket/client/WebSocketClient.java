...
public abstract class WebSocketClient extends WebSocketAdapter implements Runnable, WebSocket {
	...
	public void run() {
		try {
			...
			engine.closeConnection( CloseFrame.NEVER_CONNECTED, "WebSocketClient: Exception while executing run method" );
			return;
		}
		...
		try {
			...
			onError( e );
			engine.closeConnection( CloseFrame.ABNORMAL_CLOSE_INTERNAL_BUG, e.getMessage() );
		}
